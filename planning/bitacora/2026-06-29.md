...
## Pendientes
- [ ] Correr el control de techo: `CEILING_MODEL=<openrouter-id> python debug/gen_field_report.py`
  con `OPENROUTER_API_KEY` exportada; leer `steps/recomputes/wasted/stalled/fell_back` como veredicto
  flujo-vs-modelo.
