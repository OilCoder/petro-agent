...
## Corrida de techo: retry para 429 + 3 modelos más capaces (en curso)
...
## Pendientes
- [>] Correr el control de techo con los 3 free más capaces (nemotron-550b/gpt-oss-120b/qwen3-next-80b)
  → `outputs/v3`; leer `steps/recomputes/wasted/stalled/fell_back` como veredicto flujo-vs-modelo.
