...
- [ ] qwen-thinking quedó 3/4 (402 en el último pozo) — ¿recargar ~$1 para el pozo final,
      o basta? gpt-5 v14-default sigue parcial (2/4).
- [ ] Publicar summit v3 / actualizar la página del proyecto con el veredicto + matriz +
      esta calibración junior/senior (encaja con la sección de dos audiencias existente).
