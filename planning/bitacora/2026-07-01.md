...
### Pendientes
- [ ] Re-cierre determinista de la cadena (netpay/uncertainty) tras un recompute de core antes de render —
  el más serio, toca el camino cuantitativo (orquestador, no LLM).
- [ ] §8/§16: renderizar el método Sw real desde `sw_summary.method`, no "Archie" cableado.
- [ ] Registrar `method` en los nodos tool_call del grafo + persistir `sw_summary`/`porosity_comparison`/
...
- [ ] Sigue abierto: etiqueta "Archie" cableada en §8/§16; provenance del method en el grafo; ledger
