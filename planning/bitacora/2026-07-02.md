...
| Versión | Información sobre la objeción | Zona | wasted (mediana) |
|---|---|---|---|
| v8 | invisible (validación post-loop) | 0/11 | ~1 |
| v9 | visible, con leyenda FALSA para este caso | 0/12 | ~3 (fijación) |
| v10 | visible y VERAZ por validador | **0/8** | **~1 (fijación baja)** |
...
| Modelo | zona | authored_core | perfil |
|---|---|---|---|
| gpt-5 | 0/4 | 0–3 | explorador compulsivo: hit_max en 3/4, un pozo cerró 100% por defaults |
| deepseek-r1 | 0/4 | 3/3 | ejecutor directo: 6–10 pasos, sin opcionales |
| qwen3-max | **1/4** | 1–3 | **PRIMERA ZONA del proyecto**: 24,938 → 265.5–353.6 m (578 muestras) |
