...
| Métrica | v1 | v2 |
|---|---|---|
| Pozos | 25 | **72** (25 A + 47 B etiquetada) — verifier PASS en 72/72 (gate duro) |
| Mapa de campo | imposible | **55 pozos ubicados** por PLSS (±1.6 km declarado) |
| Arps | gradiente regional | **BHT medido en 44 pozos** (los headers vintage lo traen; los modernos no) |
| Net pay P50 | A: 55.8 m | A: 36.0 m (con DRHO badhole nuevo) · B: 18.3 m |
| Abstención | 24/25 | A: 24/25 · B: 38/47 — **9 pozos vintage CONVERGEN** |
| Anclas degeneradas | — | 0 (las anclas por-pozo absorben las escalas raras de NEUT) |
| Capítulos del spec respaldados | ~30/37 | **34/37** (quedan: SP-Rw [2 pozos, cola], Waxman-Smits/Dual-Water [sin CEC], contactos formales [cualitativo en prosa]) |
