...
- [x] Wire compute agent as the `correct` LangGraph node (`src/orchestrator/graph.py`)
- [x] Wire writer and claim verifier as `write` and `claim_verify` LangGraph nodes (`src/orchestrator/graph.py`)
